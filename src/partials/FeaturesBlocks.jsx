...
function FeaturesBlocks() {
  return (
    <section className="relative md:h-screen flex flex-grow">
      {/* Section background (needs .relative class on parent and next sibling elements) */}
      <div
        className="absolute inset-0 top-1/2 md:mt-24 lg:mt-0 bg-gray-900 dark:bg-slate-700 pointer-events-none"
        aria-hidden="true"
      ></div>
