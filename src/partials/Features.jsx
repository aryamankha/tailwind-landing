      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6">
        <div className="pt-12 md:pt-20">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-16">
            <h1 className="h2 mb-4">Built for developers</h1>
            ...
            >
              ...
              <div className="mb-8 md:mb-0">
                ...
                >
                  <div>
                    <div className="font-bold leading-snug tracking-tight mb-1">
                      Get styling "just right" on the first try
                    </div>
                    <div className="text-gray-600">
                      Edit your styling visually to make your component look
                      exactly like it does in your head.
                    </div>
                  </div>
                ...
                >
                  <div>
                    <div className="font-bold leading-snug tracking-tight mb-1">
                      Try out styling and update code right from your browser
                    </div>
                    <div className="text-gray-600">
                ...
                >
                  <div>
                    <div className="font-bold leading-snug tracking-tight mb-1">
                      Resize and realign components just by dragging
                    </div>
                    <div className="text-gray-600">
